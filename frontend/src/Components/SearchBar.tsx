...
const SearchBar = () => {
  ...
  return (
    <form
      ...
      className="grid items-center grid-cols-2 gap-4 p-3 -mt-8 bg-orange-400 shadow-md lg:grid-cols-3 2xl:grid-cols-5"
    >
      <div className="flex items-center flex-1 p-2 bg-white flow-row">
